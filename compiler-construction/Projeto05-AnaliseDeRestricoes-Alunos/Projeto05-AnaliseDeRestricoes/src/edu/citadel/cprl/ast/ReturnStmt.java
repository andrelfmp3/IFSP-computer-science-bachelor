...
public class ReturnStmt extends Statement {
    ...
    public void checkConstraints() {
        ...
        try {
            Expression expr = getReturnExpr();
            SubprogramDecl func = getSubprogramDecl();

            if (func instanceof ProcedureDecl) {
            ...
            if (expr != null) {
                ...
                if (!matchTypes(expr.getType(), func.getType())) {
                    String errorMsg = "Return expression type does not match function return type.";
                    throw error(expr.getPosition(), errorMsg);
                }
            }

            if (func instanceof FunctionDecl && expr == null) {
