...
public abstract class FirstFollowSets {
    ...
    static {
        ...
        FOLLOW_SETS.put( "literal", new Symbol[]{ 
            // ;, =, ], identifier, ,, (, ), then, loop, and, or, !=, <, <=, >, >=, +, -, *, /, mod, not
            Symbol.semicolon, 
            Symbol.equals,
            Symbol.rightBracket,
            Symbol.identifier,
        ...
        FOLLOW_SETS.put( "statement", new Symbol[]{ 
            //{ identifier, return, end, if, else, elsif, while, loop, exit, read, write, writeln }
            Symbol.identifier,
            Symbol.returnRW,
            Symbol.endRW,
            Symbol.ifRW,
        ...
        FOLLOW_SETS.put( "variable", new Symbol[]{Symbol.assign, 
            // :=, ;, intLiteral, charLiteral,  stringLiteral, true, false, =, ], identifier, ,, (, ), then, loop, and, or, !=, <, <=, >, >=, +, -, *, /, mod, not 
            Symbol.assign,
            Symbol.semicolon,
            Symbol.intLiteral,
            Symbol.charLiteral,
        ...
        FOLLOW_SETS.put( "logicalOp", new Symbol[]{ 
            // { intLiteral, charLiteral, stringLiteral, true, false, identifier, (, +, -, not }
            Symbol.intLiteral,
            Symbol.charLiteral,
            Symbol.stringLiteral,
            Symbol.trueRW,
        ...
        FOLLOW_SETS.put( "relation", new Symbol[]{ 
            // { ;, intLiteral, charLiteral, stringLiteral, true, false, ], identifier, ,, (, ), then, loop, and, or, +, -, not }
            Symbol.semicolon,
            Symbol.intLiteral,
            Symbol.charLiteral,
            Symbol.stringLiteral,
        ...
        FOLLOW_SETS.put( "factor", new Symbol[]{ 
            // {  ;, true, false, =, ], ,, ), then, loop, and, or, !=, <, <=, >, >=, +, -, *, /, mod, not }
            Symbol.semicolon,
            Symbol.trueRW,
            Symbol.falseRW,
            Symbol.equals,
        ...
        FOLLOW_SETS.put( "funcId", new Symbol[]{ 
            // { ;, intLiteral, charLiteral, stringLiteral, true, false, =, ], identifier, ,, return, (, ), then, loop, and, or, !=, <, <=, >, >=, +, -, *, /, mod, not}
            Symbol.semicolon,
            Symbol.intLiteral,
            Symbol.charLiteral,
            Symbol.stringLiteral,
