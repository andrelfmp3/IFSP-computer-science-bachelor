...
import algoritmos.dependents.common.BinaryStdOut;
import java.io.BufferedInputStream;
import java.io.IOException;
import java.util.NoSuchElementException;
// precisa de BinaryStdOut?
...
public final class BinaryStdIn {
     ...
     * Note that {@code char} is a 16-bit type; to read the next 16 bits as a
     * char, use {@code readChar(16)}.
     *
    ...
    /**
     * Reads the next <em>r</em> bits from standard input and return as an
     * <em>r</em>-bit character.
     *
     ...
     * {@code String}
     * @throws NoSuchElementException if standard input is empty or if the
     * number of bits available on standard input is not a multiple of 8
     * (byte-aligned)
     */
